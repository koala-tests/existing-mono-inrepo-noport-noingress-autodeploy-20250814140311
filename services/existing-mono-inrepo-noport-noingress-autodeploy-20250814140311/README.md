# existing-mono-inrepo-noport-noingress-autodeploy-20250814140311
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250814140311:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250814140311:latest
```
